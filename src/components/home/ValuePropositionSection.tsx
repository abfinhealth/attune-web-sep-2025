  ...
  const proofPoints = [
    {
      ...
      icon: <Users className="w-10 h-10 text-attune-teal" />
    },
    {
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 mb-16">
            <div className="flex flex-col md:flex-row items-center gap-10">
              <div className="md:w-1/3">
                <Illustration type="plant" className="mx-auto md:mx-0" />
              </div>
              <div className="md:w-2/3">
                <h3 className="text-2xl font-semibold mb-4 text-attune-teal font-display">The Attune Difference</h3>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {proofPoints.map((point, index) => (
            <ScrollAnimation key={point.title} threshold={0.2} className="delay-100">
              <div className="bg-white rounded-xl p-6 shadow-md h-full card-hover border-t-4 border-attune-teal">
                <div className="mb-4">
                  {point.icon}
                </div>
                <h3 className="text-xl font-semibold mb-3 text-gray-800 font-display">{point.title}</h3>
